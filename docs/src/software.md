...
UNION ALL
SELECT u.`id`, 2 /* Tester */, 'REVIEW_ARTIFACT', '2025-06-04 11:00:00' FROM `User` u WHERE u.`nickname` = 'bob'
UNION ALL
SELECT u.`id`, 3 /* Manager */, 'UPDATE_TASK', '2025-06-02 12:00:00' FROM `User` u WHERE u.`nickname` = 'david'
UNION ALL
SELECT u.`id`, 4 /* DevOps */, 'UPLOAD_ARTIFACT', '2025-06-06 08:20:00' FROM `User` u WHERE u.`nickname` = 'eve';
